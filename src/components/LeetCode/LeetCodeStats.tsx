  ...
  return (
    <div className="stats shadow">
      <div className="stat">
        ...
        <div className="stat-title">Submissions this Month</div>
        <div className="stat-value text-primary">Num</div>
      ...
      <div className="stat">
        ...
        <div className="stat-title">Most Recent Submission</div>
        <div className="stat-value text-secondary">Date</div>
        <div className="stat-desc">Name of Problem</div>
      </div>
      ...
      <div className="stat">
        ...
        <div className="stat-desc text-secondary">Placeholder</div>
      </div>
    </div>
  );
}
